...
const getConfigFile = require(`./get-config-file`); // Show stack trace on unhandled promises.
...
function () {
  var _ref = (0, _asyncToGenerator2.default)(function* (args) {
    ...
    activity.end();
    const flattenedPlugins = yield loadPlugins(config); // onPreBootstrap
    ...
    activity.end(); // Check if any plugins have been updated since our last run. If so
