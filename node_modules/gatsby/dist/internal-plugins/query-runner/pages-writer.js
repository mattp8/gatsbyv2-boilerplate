...
function () {
  var _ref = (0, _asyncToGenerator2.default)(function* () {
    ...
    const pagesData = _.sortBy(pages.reduce((mem, {
      path,
      matchPath,
      componentChunkName,
      jsonName
      ...
      return [...mem, Object.assign({}, pageComponentsChunkNames, {
        jsonName,
        path,
        matchPath
      })];
...
\n`;
    ...
    return yield Promise.all([writeAndMove(`pages.json`, JSON.stringify(pagesData, null, 4)), writeAndMove(`sync-requires.js`, syncRequires), writeAndMove(`async-requires.js`, asyncRequires), writeAndMove(`data.json`, JSON.stringify({
      pages: pagesData,
