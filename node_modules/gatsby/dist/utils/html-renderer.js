...
const path = require(`path`); // copied from https://github.com/markdalgleish/static-site-generator-webpack-plugin/blob/master/index.js#L161
...
module.exports = (htmlComponentRenderer, pages) => new Promise((resolve, reject) => {
  const queue = new Queue((path, callback) => {
    try {
