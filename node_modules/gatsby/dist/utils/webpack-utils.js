  ...
  var _ref = (0, _asyncToGenerator2.default)(function* ({
    ...
    const loaders = {
      ...
      miniCssExtract: (options = {}) => {
        return {
          ...
          loader: PRODUCTION ? stage === `build-html` ? require.resolve(`./webpack-extract-css-modules-map`) : MiniCssExtractPlugin.loader : require.resolve(`style-loader`)
        };
      },
      css: (options = {}) => {
        return {
      ...
      postcss: (options = {}) => {
        let _plugins = options.plugins,
            ...
            postcssOpts = (0, _objectWithoutProperties2.default)(options, ["plugins", "browsers"]);
        return {
...

    {
      const css = (_ref2 = {}) => {
        ...
        return {
          test: /\.css$/,
          use: [loaders.miniCssExtract(), loaders.css(Object.assign({}, options, {
            importLoaders: 1
          })), loaders.postcss({
            browsers
          })]
